...
import { Add, Edit, ArrowBack, CameraAlt } from "@mui/icons-material";
...
const GroupEditor = ({ group }: GroupEditorProps) => {
  ...
  const { formik, isPending, isLoadingImage } = useGroupEditor(group);
    ...
    <>
      <Box className="flex items-end justify-end">
        ...
        >
          ...
          {!isMobile && group ? "Edit Group" : "New Group"}
        </Button>
      </Box>
      <AppModal
        className="w-full h-full !overflow-y-auto !rounded-none md:max-w-xl md:h-auto md:min-h-0 md:!rounded-xl"
        isOpen={isOpen}
